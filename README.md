...
|   `puppeth`   | a CLI wizard that aids in creating a new Simongdium network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
As a developer, sooner rather than later you'll want to start interacting with `gsmc` and the
