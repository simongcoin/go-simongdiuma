...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsmc.ipc", false, filepath.Join(os.TempDir(), "gsmc.ipc")},
		{"data", "gsmc.ipc", false, "data/gsmc.ipc"},
		{"data", "./gsmc.ipc", false, "./gsmc.ipc"},
		{"data", "/gsmc.ipc", false, "/gsmc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsmc.ipc", true, `\\.\pipe\gsmc.ipc`},
		{"data", "gsmc.ipc", true, `\\.\pipe\gsmc.ipc`},
		{"data", `\\.\pipe\gsmc.ipc`, true, `\\.\pipe\gsmc.ipc`},
	}
