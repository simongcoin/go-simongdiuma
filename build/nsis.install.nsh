Name "gsmc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/simongcoin/go-simongdiuma/issues"
!define UPDATEURL "https://github.com/simongcoin/go-simongdiuma/releases"
!define ABOUTURL "https://github.com/simongcoin/go-simongdiuma#ethereum-go"
...
# Install gsmc binary
Section "Gsmc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gsmc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsmc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsmc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gsmc incoming peers (TCP:22030)"
  SimpleFC::AdvRemoveRule "Gsmc outgoing peers (TCP:22030)"
  SimpleFC::AdvRemoveRule "Gsmc UDP discovery (UDP:22030)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsmc incoming peers (TCP:22030)" ""  6 1 1 2147483647 1 "$INSTDIR\gsmc.exe" "" "" "Ethereum" 22030 "" "" ""
  SimpleFC::AdvAddRule "Gsmc outgoing peers (TCP:22030)" ""  6 2 1 2147483647 1 "$INSTDIR\gsmc.exe" "" "" "Ethereum" "" 22030 "" ""
  SimpleFC::AdvAddRule "Gsmc UDP discovery (UDP:22030)" "" 17 2 1 2147483647 1 "$INSTDIR\gsmc.exe" "" "" "Ethereum" "" 22030 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gsmc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gsmc.ipc"
